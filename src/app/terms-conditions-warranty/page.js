// privacy-policy.js in your pages directory

import React from "react";
import styles from "./terms-conditions-warranty.module.css"; // Assuming you are using CSS modules
import { Box } from "@mui/material";

const TermsConditionsWarranty = () => {
  return (
    <Box
      sx={{
    ...
    >
      ...
      <p>Welcome to Go Green Booty!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of Go Green Booty's Website, located at https://gogreenbooty.com/.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Go Green Booty if you do not agree to
      ...
      <p>
        We employ the use of cookies. By accessing Go Green Booty, you agreed to
        use cookies in agreement with the Go Green Booty's Privacy Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, Go Green Booty and/or its licensors own the
        intellectual property rights for all material on Go Green Booty. All
        intellectual property rights are reserved. You may access this from Go
        Green Booty for your own personal use subjected to restrictions set in
        these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from Go Green Booty</li>
        <li>Sell, rent or sub-license material from Go Green Booty</li>
        <li>Reproduce, duplicate or copy material from Go Green Booty</li>
        <li>Redistribute content from Go Green Booty</li>
      </ul>
      ...
      <p>
        ...
        Green Booty does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of Go Green Booty,its agents and/or affiliates. Comments
        reflect the views and opinions of the person who post their views and
        opinions. To the extent permitted by applicable laws, Go Green Booty
      ...
      <p>
        Go Green Booty reserves the right to monitor all Comments and to remove
      ...
      <p>
        You hereby grant Go Green Booty a non-exclusive license to use,
      ...
      <p>
        ...
        the hyperlink compensates the absence of Go Green Booty; and (d) the
      ...
      <p>
        ...
        e-mail to Go Green Booty. Please include your name, your organization
      ...
      <p>
        No use of Go Green Booty's logo or other artwork will be allowed for
...
export default TermsConditionsWarranty;
